...
int main(int argc, char * argv[]) {
    ...
    while (running) {
        ...
        if (programMode == DisplayingDefault) {
            ...
            runColorTest();
            // writeScrollable("abcdefghijklmnopqrstuvwxyz", 0x20, 100);
            // writeScrollable("Due to recent severe heat, traffic signals without power may be", 0x10, 100);
